...
int main(int argc, char *argv[]) {
  ...
  19:	ff 73 04             	pushl  0x4(%ebx)
  1c:	e8 0f 03 00 00       	call   330 <atoi>
  21:	83 c4 10             	add    $0x10,%esp
  24:	83 f8 01             	cmp    $0x1,%eax
  27:	74 73                	je     9c <main+0x9c>
  ...
  2f:	e8 fc 02 00 00       	call   330 <atoi>
  34:	83 c4 10             	add    $0x10,%esp
  37:	83 f8 02             	cmp    $0x2,%eax
  3a:	74 40                	je     7c <main+0x7c>
  ...
  42:	e8 e9 02 00 00       	call   330 <atoi>
  47:	83 c4 10             	add    $0x10,%esp
  4a:	83 f8 03             	cmp    $0x3,%eax
  ...
  55:	e8 d6 02 00 00       	call   330 <atoi>
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	83 f8 04             	cmp    $0x4,%eax
  60:	74 4b                	je     ad <main+0xad>
	    exit();
	  }
	  wait();
  ...
  68:	e8 c3 02 00 00       	call   330 <atoi>
  6d:	83 c4 10             	add    $0x10,%esp
  70:	83 f8 05             	cmp    $0x5,%eax
  73:	74 7b                	je     f0 <main+0xf0>
	  chdir("temp");
	  chdir("..");
  ...
  75:	e8 c9 03 00 00       	call   443 <countTraps>
  7a:	eb 1b                	jmp    97 <main+0x97>
	  countTraps();
  7c:	e8 c2 03 00 00       	call   443 <countTraps>
	  printf(0, "printing 30 new characters...\n");
  81:	52                   	push   %edx
  82:	52                   	push   %edx
  83:	68 68 08 00 00       	push   $0x868
  88:	6a 00                	push   $0x0
  8a:	e8 71 04 00 00       	call   500 <printf>
	  countTraps(); // expected result: 31 more than original
  8f:	e8 af 03 00 00       	call   443 <countTraps>
  94:	83 c4 10             	add    $0x10,%esp
	    exit();
  97:	e8 07 03 00 00       	call   3a3 <exit>
	  countTraps();
  9c:	e8 a2 03 00 00       	call   443 <countTraps>
	  countTraps();
  a1:	e8 9d 03 00 00       	call   443 <countTraps>
	  countTraps(); // expected result: 2 more than original
  a6:	e8 98 03 00 00       	call   443 <countTraps>
  ab:	eb ea                	jmp    97 <main+0x97>
	  countTraps();
  ad:	e8 91 03 00 00       	call   443 <countTraps>
	  if (fork()==0) {
  b2:	e8 e4 02 00 00       	call   39b <fork>
  b7:	85 c0                	test   %eax,%eax
  b9:	75 6c                	jne    127 <main+0x127>
	    if (fork()==0) {
  bb:	e8 db 02 00 00       	call   39b <fork>
  c0:	85 c0                	test   %eax,%eax
  c2:	74 d3                	je     97 <main+0x97>
	    wait();
  c4:	e8 e2 02 00 00       	call   3ab <wait>
  c9:	eb cc                	jmp    97 <main+0x97>
	  countTraps();
  cb:	e8 73 03 00 00       	call   443 <countTraps>
	  int fd = open("temp.txt", 'r');
  d0:	50                   	push   %eax
  d1:	50                   	push   %eax
  d2:	6a 72                	push   $0x72
  d4:	68 87 08 00 00       	push   $0x887
  d9:	e8 05 03 00 00       	call   3e3 <open>
	  close(fd);
  de:	89 04 24             	mov    %eax,(%esp)
  e1:	e8 e5 02 00 00       	call   3cb <close>
	  countTraps(); // expected result: 3 more than original
  e6:	e8 58 03 00 00       	call   443 <countTraps>
  eb:	83 c4 10             	add    $0x10,%esp
  ee:	eb a7                	jmp    97 <main+0x97>
	  countTraps();
  f0:	e8 4e 03 00 00       	call   443 <countTraps>
	  mkdir("temp");
  f5:	83 ec 0c             	sub    $0xc,%esp
  f8:	68 90 08 00 00       	push   $0x890
  fd:	e8 09 03 00 00       	call   40b <mkdir>
	  chdir("temp");
 102:	c7 04 24 90 08 00 00 	movl   $0x890,(%esp)
 109:	e8 05 03 00 00       	call   413 <chdir>
	  chdir("..");
 10e:	c7 04 24 95 08 00 00 	movl   $0x895,(%esp)
 115:	e8 f9 02 00 00       	call   413 <chdir>
	  countTraps(); // expected result: 4 more than original
 11a:	e8 24 03 00 00       	call   443 <countTraps>
 11f:	83 c4 10             	add    $0x10,%esp
 122:	e9 70 ff ff ff       	jmp    97 <main+0x97>
	  wait();
 127:	e8 7f 02 00 00       	call   3ab <wait>
	  countTraps(); // expected result: 7 more than original
 12c:	e8 12 03 00 00       	call   443 <countTraps>
 131:	e9 61 ff ff ff       	jmp    97 <main+0x97>
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb 98 08 00 00       	mov    $0x898,%ebx
        while(*s != 0){
