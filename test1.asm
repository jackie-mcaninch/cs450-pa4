...
int main(int argc, char *argv[]) {
  ...
  13:	8d 75 be             	lea    -0x42(%ebp),%esi
  16:	8d 7d c2             	lea    -0x3e(%ebp),%edi
int main(int argc, char *argv[]) {
  19:	53                   	push   %ebx
	
	mkdir("testfolder");
	chdir("testfolder");
  1a:	bb 30 00 00 00       	mov    $0x30,%ebx
int main(int argc, char *argv[]) {
  1f:	51                   	push   %ecx
  20:	83 ec 4c             	sub    $0x4c,%esp
  23:	8b 41 04             	mov    0x4(%ecx),%eax
	memmove(temp_name, "testX.txt\0", 10);
  26:	6a 0a                	push   $0xa
  28:	68 48 08 00 00       	push   $0x848
  2d:	56                   	push   %esi
int main(int argc, char *argv[]) {
  2e:	89 45 b0             	mov    %eax,-0x50(%ebp)
	memmove(temp_name, "testX.txt\0", 10);
  31:	e8 0a 03 00 00       	call   340 <memmove>
	mkdir("testfolder");
  36:	c7 04 24 53 08 00 00 	movl   $0x853,(%esp)
  3d:	e8 99 03 00 00       	call   3db <mkdir>
	chdir("testfolder");
  42:	c7 04 24 53 08 00 00 	movl   $0x853,(%esp)
  49:	e8 95 03 00 00       	call   3e3 <chdir>
  4e:	83 c4 10             	add    $0x10,%esp
  51:	eb 37                	jmp    8a <main+0x8a>
  ...
  5b:	6a 04                	push   $0x4
  5d:	68 72 08 00 00       	push   $0x872
  62:	50                   	push   %eax
  63:	e8 2b 03 00 00       	call   393 <write>
  68:	83 c4 10             	add    $0x10,%esp
  6b:	83 f8 04             	cmp    $0x4,%eax
  6e:	74 12                	je     82 <main+0x82>
			printf(2, "ERROR WRITING!\n");
  70:	83 ec 08             	sub    $0x8,%esp
  73:	68 77 08 00 00       	push   $0x877
  78:	6a 02                	push   $0x2
  7a:	e8 61 04 00 00       	call   4e0 <printf>
  7f:	83 c4 10             	add    $0x10,%esp
	for (int i=0; i<num_tests; i++){
  82:	83 c3 01             	add    $0x1,%ebx
  85:	83 fb 38             	cmp    $0x38,%ebx
  88:	74 46                	je     d0 <main+0xd0>
		memset(temp_name+4, i+48, 1);
  8a:	83 ec 04             	sub    $0x4,%esp
  8d:	6a 01                	push   $0x1
  8f:	53                   	push   %ebx
  90:	57                   	push   %edi
  91:	e8 3a 01 00 00       	call   1d0 <memset>
		if((fd[i] = open(temp_name, O_CREATE|O_RDWR))<0){
  96:	58                   	pop    %eax
  97:	5a                   	pop    %edx
  ...
  a6:	89 84 9d 08 ff ff ff 	mov    %eax,-0xf8(%ebp,%ebx,4)
  ad:	85 c0                	test   %eax,%eax
  af:	79 a7                	jns    58 <main+0x58>
			printf(2, "ERROR OPENING FILE!");
  b1:	83 ec 08             	sub    $0x8,%esp
  b4:	89 45 b4             	mov    %eax,-0x4c(%ebp)
  b7:	68 5e 08 00 00       	push   $0x85e
  bc:	6a 02                	push   $0x2
  be:	e8 1d 04 00 00       	call   4e0 <printf>
  c3:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  c6:	83 c4 10             	add    $0x10,%esp
  c9:	eb 8d                	jmp    58 <main+0x58>
  ...
  d6:	8d 5d c8             	lea    -0x38(%ebp),%ebx
  d9:	8d 75 e8             	lea    -0x18(%ebp),%esi
  dc:	ff 70 04             	pushl  0x4(%eax)
  df:	e8 2f 03 00 00       	call   413 <walkDir>
	walkInodes();
  e4:	e8 32 03 00 00       	call   41b <walkInodes>
	for (int i=0; i<num_tests; i++) {
  ...
  f8:	e8 9e 02 00 00       	call   39b <close>
	for (int i=0; i<num_tests; i++) {
  fd:	83 c4 10             	add    $0x10,%esp
 100:	39 f3                	cmp    %esi,%ebx
 102:	75 ec                	jne    f0 <main+0xf0>
	}
	
	compareWalkers();
 104:	e8 1a 03 00 00       	call   423 <compareWalkers>
	exit();
 109:	e8 65 02 00 00       	call   373 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb 87 08 00 00       	mov    $0x887,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b5:	a1 48 0b 00 00       	mov    0xb48,%eax
{
...
malloc(uint nbytes)
{
 ...
 74d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 750:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c2:	e8 e9 fe ff ff       	call   6b0 <free>
  return freep;
 7c7:	a1 48 0b 00 00       	mov    0xb48,%eax
 ...
 7f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7f7:	a3 48 0b 00 00       	mov    %eax,0xb48
}
