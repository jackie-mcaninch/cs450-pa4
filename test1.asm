...
int main(int argc, char *argv[]) {
  ...
  13:	8d 75 ca             	lea    -0x36(%ebp),%esi
  16:	8d 7d ce             	lea    -0x32(%ebp),%edi
int main(int argc, char *argv[]) {
  19:	53                   	push   %ebx
...
int main(int argc, char *argv[]) {
  ...
  20:	83 ec 3c             	sub    $0x3c,%esp
	memmove(temp_name, "testX.txt\0", 10);
  23:	6a 0a                	push   $0xa
  25:	68 38 08 00 00       	push   $0x838
  2a:	56                   	push   %esi
  2b:	e8 10 03 00 00       	call   340 <memmove>
	mkdir("testfolder");
  30:	c7 04 24 43 08 00 00 	movl   $0x843,(%esp)
  37:	e8 9f 03 00 00       	call   3db <mkdir>
	chdir("testfolder");
  3c:	c7 04 24 43 08 00 00 	movl   $0x843,(%esp)
  43:	e8 9b 03 00 00       	call   3e3 <chdir>
  ...
  50:	53                   	push   %ebx
  51:	57                   	push   %edi
  52:	e8 79 01 00 00       	call   1d0 <memset>
		printf(1, "%s\n", temp_name);
  57:	83 c4 0c             	add    $0xc,%esp
  5a:	56                   	push   %esi
  5b:	68 4e 08 00 00       	push   $0x84e
  60:	6a 01                	push   $0x1
  62:	e8 69 04 00 00       	call   4d0 <printf>
		if((fd[i] = open(temp_name, O_CREATE|O_RDWR))<0){
  67:	58                   	pop    %eax
  68:	5a                   	pop    %edx
  69:	68 02 02 00 00       	push   $0x202
  6e:	56                   	push   %esi
  6f:	e8 3f 03 00 00       	call   3b3 <open>
  74:	83 c4 10             	add    $0x10,%esp
  77:	89 84 9d 14 ff ff ff 	mov    %eax,-0xec(%ebp,%ebx,4)
  7e:	85 c0                	test   %eax,%eax
  80:	78 66                	js     e8 <main+0xe8>
			printf(2, "ERROR OPENING FILE!");
		}
		if (write(fd[i], "asdf", 4) != 4) {
  82:	83 ec 04             	sub    $0x4,%esp
  85:	6a 04                	push   $0x4
  87:	68 66 08 00 00       	push   $0x866
  8c:	50                   	push   %eax
  8d:	e8 01 03 00 00       	call   393 <write>
  92:	83 c4 10             	add    $0x10,%esp
  95:	83 f8 04             	cmp    $0x4,%eax
  98:	74 12                	je     ac <main+0xac>
			printf(2, "ERROR WRITING!\n");
  9a:	83 ec 08             	sub    $0x8,%esp
  9d:	68 6b 08 00 00       	push   $0x86b
  a2:	6a 02                	push   $0x2
  a4:	e8 27 04 00 00       	call   4d0 <printf>
  a9:	83 c4 10             	add    $0x10,%esp
	for (int i=0; i<num_tests; i++){
  ac:	83 c3 01             	add    $0x1,%ebx
  af:	83 fb 35             	cmp    $0x35,%ebx
  b2:	75 97                	jne    4b <main+0x4b>
		}
		
	}
	walkDir("testfolder");
  b4:	83 ec 0c             	sub    $0xc,%esp
  b7:	8d 5d d4             	lea    -0x2c(%ebp),%ebx
  ba:	8d 75 e8             	lea    -0x18(%ebp),%esi
  bd:	68 43 08 00 00       	push   $0x843
  c2:	e8 4c 03 00 00       	call   413 <walkDir>
	for (int i=0; i<num_tests; i++) {
  c7:	83 c4 10             	add    $0x10,%esp
		close(fd[i]);
  ca:	83 ec 0c             	sub    $0xc,%esp
  cd:	ff 33                	pushl  (%ebx)
  cf:	83 c3 04             	add    $0x4,%ebx
  d2:	e8 c4 02 00 00       	call   39b <close>
	for (int i=0; i<num_tests; i++) {
  d7:	83 c4 10             	add    $0x10,%esp
  da:	39 f3                	cmp    %esi,%ebx
  dc:	75 ec                	jne    ca <main+0xca>
	}
	exit();
  de:	e8 90 02 00 00       	call   373 <exit>
  e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  e7:	90                   	nop
			printf(2, "ERROR OPENING FILE!");
  e8:	83 ec 08             	sub    $0x8,%esp
  eb:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  ee:	68 52 08 00 00       	push   $0x852
  f3:	6a 02                	push   $0x2
  f5:	e8 d6 03 00 00       	call   4d0 <printf>
  fa:	8b 45 c4             	mov    -0x3c(%ebp),%eax
  fd:	83 c4 10             	add    $0x10,%esp
 100:	eb 80                	jmp    82 <main+0x82>
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 7b 08 00 00       	mov    $0x87b,%ebx
        while(*s != 0){
